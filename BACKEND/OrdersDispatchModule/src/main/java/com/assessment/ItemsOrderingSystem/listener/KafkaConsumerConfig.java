...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, OrderDTO>> listenerContainerFactory(ConsumerFactory<String, OrderDTO> consumerFactory){
